...
Fork repo: https://github.com/Strobotti/php-jwk
...
$keyFactory = new Ethantechnology\JWK\KeyFactory();
...
$keySet = new \Ethantechnology\JWK\KeySet();
$keySet->addKey($key);
...
$pem = (new \Ethantechnology\JWK\KeyConverter())->keyToPem($key);
